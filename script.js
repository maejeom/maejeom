const items = [
  ...
  { name: "바베큐맛 스낵", category: "과자", price: 0, tags: ["짭짤한"] },
  { name: "꼬불꼬불 매콤한 라볶이", category: "과자", price: 0, tags: ["매운"] },
  { name: "감자알칩", category: "과자", price: 0, tags: ["짭짤한", "고소한"] },
  { name: "닭다리형 꼬꼬 스낵", category: "과자", price: 0, tags: ["짭짤한"] },
  { name: "뻥이요", category: "과자", price: 0, tags: ["고소한"] },
  { name: "비쵸비", category: "과자", price: 0, tags: ["짭짤한"] },
  { name: "오뜨", category: "과자", price: 0, tags: ["달콤한"] },
  { name: "구운감자", category: "과자", price: 0, tags: ["고소한"] },
  { name: "예감", category: "과자", price: 0, tags: ["고소한"] },
  { name: "다이제", category: "과자", price: 0, tags: ["달콤한", "고소한"] },
  { name: "초코칩쿠키", category: "과자", price: 0, tags: ["달콤한"] },
  { name: "오레오", category: "과자", price: 0, tags: ["달콤한"] },
  { name: "빼빼로 아몬드", category: "과자", price: 0, tags: ["달콤한", "고소한"] },
  { name: "체스터 쿵", category: "과자", price: 0, tags: ["짭짤한"] },
  { name: "스위트콘 나쵸", category: "과자", price: 0, tags: ["달콤한", "짭짤한", "고소한"] },
  { name: "콘칲", category: "과자", price: 0, tags: ["고소한"] },
  { name: "ABC 초코쿠키", category: "과자", price: 0, tags: ["달콤한"] },
  { name: "쿠크다스", category: "과자", price: 0, tags: ["달콤한"] },
  { name: "화이트하임", category: "과자", price: 0, tags: ["달콤한"] },
  { name: "초코하임", category: "과자", price: 0, tags: ["달콤한"] },
  { name: "초코송이", category: "과자", price: 0, tags: ["달콤한"] },
  { name: "쫀득 초코칩", category: "과자", price: 0, tags: ["달콤한"] },
  { name: "찍먹나쵸 치폴레마요", category: "과자", price: 0, tags: ["매운", "짭짤한"] },
  { name: "도도한나쵸 사워크림&어니언", category: "과자", price: 0, tags: ["신맛 나는", "짭짤한"] },
  { name: "신당동떡볶이", category: "과자", price: 0, tags: ["매운"] },
  { name: "치킨팝 닭강정맛", category: "과자", price: 0, tags: ["짭짤한", "달콤한", "매운"] },
  { name: "뿌셔뿌셔 양념치킨맛", category: "과자", price: 0, tags: ["짭짤한", "매운"] },
  { name: "쫄병 매콤한맛", category: "과자", price: 0, tags: ["고소한", "매운"] },
  { name: "도리토스 플레이밍핫 사우어칠리라임맛", category: "과자", price: 0, tags: ["매운", "신맛 나는"] },
  { name: "도리토스 나쵸치즈맛", category: "과자", price: 0, tags: ["짭짤한"] },
  { name: "포카칩 어니언맛", category: "과자", price: 0, tags: ["짭짤한"] },
  { name: "허니버터칩", category: "과자", price: 0, tags: ["달콤한", "고소한"] },
  { name: "꽃게랑 불짬뽕", category: "과자", price: 0, tags: ["매운", "짭짤한"] },
  { name: "매운새우깡", category: "과자", price: 0, tags: ["매운", "짭짤한"] },
  { name: "꼬깔콘 매드핫", category: "과자", price: 0, tags: ["매운"] },
  { name: "츄러스", category: "과자", price: 0, tags: ["달콤한"] },
  { name: "마켓오 브라우니 말차", category: "과자", price: 0, tags: ["달콤한", "쌉싸름한"] },
  { name: "메론킥", category: "과자", price: 0, tags: ["달콤한"] },
  { name: "바나나킥", category: "과자", price: 0, tags: ["달콤한"] }
];
